...
public class InterfaceCaractere {
    ...
    /**
     * Mátodo que imprime o estado atual do tabuleiro de jogo depois de cada
     * ação.
     */
    ...
    /**
     * Método que aguarda a escolha do usuário e a direciona, para a ação ser
     * executada.
     */
    ...
    /**
     * Método responsável por direcionar a ação de mudar o número de cartas à
     * virar do estoque.
     */
    private void caso1() {
        System.out.println("_______________________________________________________________________________________________________________________________________\n");
