...
public final class Mesa {
    ...
    /**
     * Construtor.
     * @param fund = fundações
     * @param fil = fileiras
     * @param type
     */
    public Mesa(int fund, int fil, String type){
        //Paciência -> 4 fundações e 7 fileiras
        //Big Bertha -> 9 fundações e 15 fileiras
        this.fundacoes = new Stack[fund];
        this.fileiras = new Stack[fil];
        
        this.criarPilhas(fund, fil);

        if(type.equals("paciencia")) {
            this.baralho = new Baralho().getBaralho();
            this.descarte = new Stack<>();
            this.qtdEstoque = 1;
            this.distribuirJogo(baralho);
        } else {
            this.baralho = new Baralho().getBaralho();
            this.descarte = new Stack<>();
        }
     ...
     */
    private void criarPilhas(int fund, int fil){
    ...
    /**
     * Método que altera a quantidade de cartas que devem ser viradas da pilha de baralho.
     * @param qtd
     */
    ...
    /**
     * Método que retorna o estado atual da pilha de baralho.
     * @return
     */
    ...
    /**
     * Método que move as cartas da pilha de baralho para a pilha de descarte.
     * @return
     */
    public String pedirCarta(){
        if(baralho.empty() && descarte.empty()){
            return "Não há mais cartas!";
        }
        else if(!baralho.empty()){
